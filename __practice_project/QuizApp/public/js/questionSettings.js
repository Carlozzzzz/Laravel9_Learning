    ...
    function saveQuestionnaireHTML(form){
        ...
        if (form.classList.contains(QuestionCategories.MULTIPLE_CHOICE + "-input")) {
            ...
            questionObj = {
                ...
                answerKey   : $("#questionnaire-input input[name='answerKey']:radio:checked").attr('data-id'),
                choices     : {
                                'txtChoice1' : $('#txtChoice1').val(),
                                'txtChoice2' : $('#txtChoice2').val(),
                            }
            };
            ...
            $("#questionnaire-input .choices-container input:text").each(function () {
            ...
            let answerKey = checkListChoices.filter((element) => element.isSelected).map((element) => element.name);

            checkListChoices.shift() // removing question to the array
            ...
            console.log(enumerationInputs);

            questionObj = {
                id          : dataId,
                category    : QuestionCategories.ENUMERATION,
                question    : $('#category-question').val(),
                answerKey   : enumerationInputs,
            };
        }
