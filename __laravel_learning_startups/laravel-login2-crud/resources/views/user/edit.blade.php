...
<div class="relative w-full max-w-2xl max-h-full">
    <!-- Modal content -->
    <form action="{{ url('/users/update/'.$data_datarecordfile->id) }}" method="POST" enctype="multipart/form-data" class="relative bg-white rounded-lg shadow dark:bg-gray-700 mx-auto">
        @method('PUT')
        @csrf
        <!-- Modal header -->
            ...
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6">
                    <div class="flex justify-center">
                        <x-user.editUserImage :image="$data_datarecordfile->user_image" />
                    </div>
