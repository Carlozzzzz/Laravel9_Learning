@include('partials.header')
    ...
    <main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-md shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2">Sign up <a href="/register" class="text-purple-400 font-bold">here</a></p>
        </section>
        <section class="mt-10">
            <form action="/login/process" method="POST" class="flex flex-col">
                ...
                <div class="mb-6 pt-4 rounded bg-gray-200">
                    ...
                    <input type="email" id="email" name="email" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value={{old('email')}}>
                </div>
                <div class="mb-6 pt-4 rounded bg-gray-200">
                ...
                <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-700">Sign in</button>
            </form>
        </section>
    </main>
